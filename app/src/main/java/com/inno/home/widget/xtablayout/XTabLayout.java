package com.inno.home.widget.xtablayout;
...
public class XTabLayout extends HorizontalScrollView {
    ...
    private static final Pools.Pool<Tab> TAB_POOL = new Pools.SynchronizedPool<>(16);
    //文本字母是否小写转大写
    ...
    public interface OnTabSelectedListener {
         ...
         */
        void onTabUnselected(XTabLayout.Tab tab);
         ...
         */
        void onTabReselected(XTabLayout.Tab tab);
    }
   ...
   /*     TypedArray a = context.obtainStyledAttributes(attrs, android.support.design.R.styleable.TabLayout,
        ...
        try {
            if (mTabTextSize == 0) {
                mTabTextSize = ta.getDimensionPixelSize(android.support.design.
                        R.styleable.TextAppearance_android_textSize, 0);
            }
            mTabTextColors = ta.getColorStateList(android.support.design.
        ...
        mScrollableTabMinWidth = res.getDimensionPixelSize(android.support.design.
                R.dimen.design_tab_scrollable_min_width);
...
//        invalidate();
    ...
    public XTabLayout.Tab newTab() {
        XTabLayout.Tab tab = TAB_POOL.acquire();
        if (tab == null) {
...
//        removeAllTabs();
        ...
        if (mPagerAdapter != null) {
            ...
            if (tabCount < adapterCount) {
                for (int i = 0; i < Math.abs(tabCount - adapterCount); i++) {
                    addTab(newTab().setText(mPagerAdapter.getPageTitle(i)), false);
                }
            } else {
                for (int i = 0; i < Math.abs(tabCount - adapterCount); i++) {
                    removeTab(mTabs.get(mTabs.size() - 1));
                }
            }
            for (int i = 0; i < adapterCount; i++) {
//                addTab(newTab().setText(mPagerAdapter.getPageTitle(i)), false);
                mTabs.get(i).setText(mPagerAdapter.getPageTitle(i));
                mTabStrip.getChildAt(i).setSelected(false);
                if (currentTab != null
                        && mPagerAdapter.getPageTitle(i).equals(currentTab.getText())) {
                    mTabs.get(i).select();
    ...
    public void selectTab(XTabLayout.Tab tab) {
        selectTab(tab, true);
    }
    ...
    public static final class Tab {
       ...
       /* private Tab() {
        ...
        public Tab(XTabLayout parent, String text) {
            mParent = parent;
            mText = text;
        }
         ...
         */
        @Nullable
        public XTabLayout.TabView getView() {
            return mView;
        }
         ...
         * <p>
         * If the provided view contains a {@link TextView} with an dataId of
         ...
         * {@link ImageView} with dataId {@link android.R.id#icon} then it will be updated with
         ...
         * Set a custom view to be used for this tab.
         * <p>
         * If the inflated layout contains a {@link TextView} with an dataId of
         * {@link android.R.id#text1} then that will be updated with the value given
         * to {@link #setText(CharSequence)}. Similarly, if this layout contains an
         * {@link ImageView} with dataId {@link android.R.id#icon} then it will be updated with
         * the value given to {@link #setIcon(Drawable)}.
         ...
         * Set the icon displayed on this tab.
         *
         * @param resId A resource dataId referring to the icon that should be displayed
         * @return The current instance for call chaining
         */
        @NonNull
         ...
         * the entire string.
         *
         * @param resId A resource dataId referring to the text that should be displayed
         * @return The current instance for call chaining
         */
        @NonNull
         ...
         *
         * @param resId A resource dataId referring to the description text
         * @return The current instance for call chaining
...
//                        mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        private float radiusX = UiUtil.dip2px(1);
        private float radiusY = UiUtil.dip2px(1);
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
               ...
               /* int maxWidth = mIndicatorRight - mIndicatorLeft;
                ...
                canvas.drawRoundRect(mIndicatorLeft, getHeight() - mSelectedIndicatorHeight,
                        mIndicatorRight, getHeight(), radiusX, radiusY, mSelectedIndicatorPaint);
            }
        }
    }
