...
/**
 * Created by liucheng on 2018/4/24
 */

public class CategoryFragmentAdapter extends PagerAdapter {

    private final String TAG = "CategoryFragmentAdapter";
    ...
    public CategoryFragmentAdapter(FragmentManager fm, List<BaseFragment> fragments, List<String> titles) {
        mFragmentManager = fm;
        ...
        if (state != null) {
            ...
            for (String key : keys) {
                if (key.startsWith("f")) {
                    ...
                    BaseFragment f = (BaseFragment) mFragmentManager.getFragment(bundle, key);
                    if (f != null) {
