 ...
 * 所有Adapter的调度方法
 */
public interface AdapterDelegate<T extends DelegateModel, H extends RecyclerView.ViewHolder> {
     ...
     */
    void onBindViewHolder(@NonNull List<T> items, int position, @NonNull H holder);

    /**
     * 将DelegateManager的引用传入
     *
     * @param manager AdapterDelegateManager
     */
    void setManager(AdapterDelegateManager manager);
}